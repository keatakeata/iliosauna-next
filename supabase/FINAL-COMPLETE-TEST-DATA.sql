-- FINAL COMPLETE SCRIPT - Includes ALL required fields
...
-- STEP 3: Create test data with ALL fields
DO $$ 
DECLARE 
...
VALUES (test_order_id_1, 'prod_barrel_6', 'Ilio Barrel Sauna - 6 Person', 1, 15999.00, 15999.00);
...
INSERT INTO order_items (order_id, product_id, product_name, quantity, unit_price, total_price)
VALUES (test_order_id_2, 'prod_cube_4', 'Ilio Cube Sauna - 4 Person', 1, 12999.00, 12999.00);
...
INSERT INTO order_items (order_id, product_id, product_name, quantity, unit_price, total_price)
VALUES (test_order_id_3, 'prod_panoramic_8', 'Ilio Panoramic Sauna - 8 Person', 1, 18999.00, 18999.00);
...
INSERT INTO order_items (order_id, product_id, product_name, quantity, unit_price, total_price)
VALUES (test_order_id_4, 'prod_infrared_kit', 'Infrared Sauna Panel Kit', 1, 9999.00, 9999.00);
...
-- STEP 4: Show success
SELECT '🎉 SUCCESS! All test data created!' as message;

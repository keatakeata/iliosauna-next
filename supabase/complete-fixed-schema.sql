...
-- ============================================
-- Each column must be added separately in PostgreSQL
...
-- NOTE: RLS Policies using auth.uid() require Supabase Auth
-- Since you're using Clerk, we'll need to modify these policies
-- For now, let's create basic policies that allow access

-- Temporary policies for development (replace with proper Clerk integration later)
...
CREATE POLICY "Allow all for shipping_tracking" ON shipping_tracking
  FOR ALL USING (true);

CREATE POLICY "Allow all for installations" ON installations
  FOR ALL USING (true);

CREATE POLICY "Allow all for customer_documents" ON customer_documents
  FOR ALL USING (true);

CREATE POLICY "Allow all for support_tickets" ON support_tickets
  FOR ALL USING (true);

CREATE POLICY "Allow all for ticket_messages" ON ticket_messages
  FOR ALL USING (true);

-- ============================================
-- SUCCESS MESSAGE
-- ============================================
-- If you see this query succeed, all tables have been created!

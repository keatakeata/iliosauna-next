-- COMPLETE FIX: Add ALL missing columns first, then create test data
...
-- STEP 2: Add ALL missing columns to customers table
...
-- STEP 3: Clean up any existing test data (without using customer_email yet)
...
-- STEP 4: Now create test data with all columns available
DO $$ 
DECLARE 
...
SELECT 'SUCCESS! All columns added and test data created!' as message;

'use client';
// BUILD FIX v3: Removed conflicting force-dynamic export for React 19 compatibility
            ...
            <div style={{
              ...
              <nav style={{ position: 'relative' }}>
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      e.target.style.color = '#BF5813';
                      e.target.style.backgroundColor = 'rgba(191, 88, 19, 0.05)';
                      e.target.style.transform = 'translateX(4px)';
                    }}
                    onMouseLeave={(e) => {
                      e.target.style.color = activeSection === item.id ? '#BF5813' : '#6B7280';
                      e.target.style.backgroundColor = 'rgba(0, 0, 0, 0)';
                      e.target.style.transform = activeSection === item.id ? 'translateX(4px)' : 'translateX(0)';
                    }}
                  >
                    {item.text}
                  </button>

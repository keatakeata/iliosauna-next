...
export default function ProductDetailPage() {
  ...
  const currentPrice = product?.variants[selectedVariant]?.price || product?.price || 0;
            ...
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
              ...
              >
                ...
                {product.variants && product.variants.length > 0 && (
                  <div className="mb-6">
                    <label className="block text-sm font-semibold mb-3 text-gray-300">
                      Select Option ({product.variants.length} available)
                    </label>
                    <div className="grid grid-cols-2 gap-3 max-h-80 overflow-y-auto pr-2">
                      {product.variants.slice(0, 12).map((variant, idx) => (
                        <button
                          key={idx}
                        ...
                        >
                          ...
                          <div className="text-xs text-[#BF5813]">
                    ...
                    {product.variants.length > 12 && (
                      <p className="text-sm text-gray-400 mt-2">
                        +{product.variants.length - 12} more options available
                      </p>
                    )}
                  </div>
                )}
                ...
                <div className="mb-6">
                  ...
                  <div className="flex items-center gap-4">
                    <button
                      ...
                      className="w-10 h-10 rounded-lg bg-[#2a2a2a] hover:bg-[#3a3a3a] flex items-center justify-center text-xl font-bold transition-colors"
                    >
                      −
                    </button>
                ...
                <button
                  ...
                  className="w-full py-4 px-8 bg-[#BF5813] text-white text-lg font-bold rounded-lg hover:bg-[#A04810] transition-colors disabled:bg-gray-600 disabled:cursor-not-allowed mb-6"
                >
                  {!product.inStock && !product.allowOutOfStockPurchase
                    ? 'Out of Stock'
                    : 'Add to Cart'}
